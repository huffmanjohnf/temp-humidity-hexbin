...
humidity_file = st.sidebar.file_uploader("Upload himidity data file", type=["csv"])
st.sidebar.subheader("Specify uploaded humidity type:")
humidity_type = st.sidebar.selectbox("", ["Select", "Dew Point", "Relative Humidity"])
